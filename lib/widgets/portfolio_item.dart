                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      Row(
                                                                          ...
                                                                          children: List.generate(
                                                                              ...
                                                                              (int index) => AnimatedContainer(margin: const EdgeInsets.symmetric(horizontal: 4), height: 15, width: 15, decoration: BoxDecoration(shape: BoxShape.circle, color: index == currentPage ? context.primaryColor : context.primaryColor.withOpacity(0.4)), duration: const Duration(milliseconds: 300))))
                                                                    ]),
                                                              ))
                                                        ],
                                                      ),
