...
import 'package:bootstrap/widgets/contact_info_list_tile.dart';
import 'package:bootstrap/widgets/text_field.dart';
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          BootstrapRow(verticalAlignment: MainAxisAlignment.center, children: [
            BootstrapCol(
